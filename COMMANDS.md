...
## 🧐 Auditoría y Reglas
Para verificar que sigo siendo fiel a la identidad del proyecto.

- **Prompt**: "Revisa el archivo `AGENTS.md` y confírmame si estás siguiendo todas las Reglas de Oro."
- **Prompt**: "Analiza mi carpeta de `outputs` y dime si los skills cumplen con la estructura obligatoria."
